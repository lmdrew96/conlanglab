...
export function HistorySidebar({
  ...
  const history = useQuery(api.phonology.queries.historyList, isAuthenticated ? { languageId } : "skip");
  const revert = useMutation(api.phonology.mutations.revertToHistoryEntry);
